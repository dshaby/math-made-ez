      ...
      <div className="relative h-96 overflow-hidden rounded-lg md:h-96">
        {images.map((image, index) => (
          ...
          >
            ...
            />
            <div
              className="absolute inset-0 flex cursor-pointer items-center justify-center bg-black bg-opacity-50 opacity-0 transition-opacity duration-300 hover:opacity-100"
